  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="relative w-full max-w-md bg-[#E1E4D9] border border-[#DBD0C2] p-8 md:p-10 shadow-2xl rounded-[2px]">
        ...
        <h2 className="font-heading text-center text-lg tracking-[0.15em] uppercase text-[#2F3430] mb-2 font-light">
          Age Verification
        </h2>
        ...
        <div className="flex flex-col gap-3 mb-6">
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <span className="font-sans text-xs text-[#7A8A76] leading-relaxed font-light">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            onClick={exit}
            className="flex-1 bg-transparent text-[#7A8A76] hover:text-[#2F3430] font-sans text-xs tracking-[0.14em] uppercase py-3 px-6 border border-[#DBD0C2] hover:border-[#2F3430] rounded-[2px] transition-colors font-normal"
          >
            Exit
          </button>
        </div>
