...
// 'Research' and 'Wellness Journal' used to link to /blog — removed along
// with the blog section (2026-07-21), since it was never populated with
// real content and the links went nowhere useful.
const learnLinks = [
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                {/* Shared affiliate portal — one login/dashboard for every VP storefront, see vp-affiliate-portal repo */}
                <a
                  href="https://affiliate.vintagepeptides.com/msv/login"
                  className="font-sans text-[10px] uppercase tracking-[0.1em] text-[#DBD0C2]/70 hover:text-[#B08D57] transition-colors font-light"
                >
                  Affiliate Login
                </a>
