        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-8">
          ...
          <div className="space-y-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-body text-sm text-foreground-600 leading-relaxed">
                    All products and information provided by My Secret Vitality are intended for <strong className="text-foreground-950">laboratory research use only</strong>. These products are not for human consumption, injection, or medical use. They are not intended to diagnose, treat, cure, or prevent any disease or condition.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                You must be <strong className="text-foreground-950">21 years of age or older</strong> to access, browse, or purchase from this website. By using this site, you confirm that you are a qualified researcher, aged 21 or older, and that you have the knowledge, training, and facilities necessary to handle research chemicals safely and in accordance with applicable laboratory protocols.
              </p>
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                My Secret Vitality reserves the right to refuse service, terminate accounts, or cancel orders at its sole discretion if we suspect that a user does not meet these eligibility requirements or intends to use our products for purposes other than lawful research.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                All products sold by My Secret Vitality are strictly for <strong className="text-foreground-950">in vitro research and laboratory experimentation</strong> in controlled settings. This includes, but is not limited to:
              </p>
            ...
            <div className="space-y-6">
              ...
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                All statements and products on this website have <strong className="text-foreground-950">not been evaluated by the Food and Drug Administration (FDA)</strong>. No product sold by My Secret Vitality is approved for human use, nor are any claims made regarding safety, efficacy, or therapeutic benefit.
              </p>
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
            ...
            <div className="space-y-6">
              ...
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                By purchasing from My Secret Vitality, you assume full responsibility for the lawful and appropriate use of all products. You agree to indemnify and hold harmless My Secret Vitality, its affiliates, suppliers, and partners from any claims, damages, or liabilities arising from misuse, mishandling, or unlawful application of any product purchased from this site.
              </p>
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                My Secret Vitality is not liable for any injury, loss, or damage resulting from improper use, storage, or handling of research chemicals. All product descriptions, protocols, and technical data are provided for informational purposes only and do not constitute usage instructions or medical advice.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                My Secret Vitality may require additional verification, including institutional affiliation or research credentials, before processing certain orders. We reserve the right to request documentation at any time to verify compliance with this policy.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                If you have questions about this policy or require clarification on any aspect of our research-use terms, please contact our research support team at <a href="mailto:help@mysecretvitality.com" className="text-accent-500 hover:text-foreground-950 transition-colors underline underline-offset-2">help@mysecretvitality.com</a>.
              </p>
            </div>
