...
// reliably surface to the user (it silently blocks submit with no visible
// message in some browsers/autofill paths, which is what was reported:
// "I had an error in my email... it didn't give me any sort of notification").
          ...
          <div className="p-6 md:p-8 border border-secondary-500/30 bg-background-100/40">
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="font-heading text-[10px] tracking-[0.2em] uppercase text-foreground-950 block mb-1.5">
                    Phone Number <span className="text-foreground-600/50 normal-case tracking-normal font-body">(optional)</span>
                  </label>
                  <input
                    type="tel"
                    value={form.phone}
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-background-50 border border-secondary-500/40 py-2.5 pl-3 pr-10 font-body text-sm text-foreground-950 placeholder:text-foreground-600/50 focus:outline-none focus:border-accent-500 transition-colors"
                    ...
                    <button
                      ...
                      className="absolute right-0 top-0 h-full w-10 flex items-center justify-center text-foreground-600 hover:text-accent-500 transition-colors"
                    >
                      <i className={showPassword ? 'ri-eye-off-line' : 'ri-eye-line'} />
                    </button>
                  </div>
                  <p className="font-body text-[11px] text-foreground-600/70 mt-1">
