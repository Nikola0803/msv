      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto mb-12">
          <div className="bg-white border-[0.5px] border-[#DBD0C2] rounded-[4px] p-6 md:p-8 relative">
            <span className="absolute top-4 right-6 text-[80px] leading-none text-[#4A5C4A]/15 font-heading italic select-none pointer-events-none">
              &ldquo;
            </span>
            ...
            <div className="relative z-[1]">
              ...
              <div className="mt-6 flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-[#8E9A8A]/15 flex items-center justify-center flex-shrink-0">
                  <span className="font-heading text-sm text-[#4A5C4A] font-semibold">{testimonials[0].initials}</span>
                </div>
                <div>
                  <p className="font-heading text-sm text-[#2F3430] font-semibold">{testimonials[0].name}</p>
                  <p className="font-sans text-[11px] text-[#3D4E3D] font-light">{testimonials[0].role}</p>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div className="bg-white border-[0.5px] border-[#DBD0C2] rounded-[4px] p-5 flex flex-col h-full">
                      ...
                      <blockquote className="mt-3 flex-1">
                        ...
                        {t.quote.length > 140 && (
                          <button
                            ...
                            className="font-sans text-[11px] text-[#4A5C4A] font-medium mt-1 hover:text-[#B08D57] transition-colors cursor-pointer"
                          >
                      ...
                      <div className="mt-4 flex items-center gap-3 pt-4 border-t border-[#DBD0C2]/70">
                        <div className="w-8 h-8 rounded-full bg-[#8E9A8A]/10 flex items-center justify-center flex-shrink-0">
                          <span className="font-heading text-xs text-[#4A5C4A] font-semibold">
                            {t.initials}
                          </span>
                        </div>
                        <div>
                          ...
                          <p className="font-sans text-[10px] text-[#3D4E3D] font-light">{t.role}</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-6 bg-white border-[0.5px] border-[#DBD0C2] rounded-[4px] px-6 py-4">
            <div className="text-center">
              ...
              <p className="font-sans text-[10px] text-[#3D4E3D] mt-1 font-light">{s.agg_reviews} reviews</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-sans text-[10px] text-[#3D4E3D] mt-1 font-light">Avg. Purity</p>
            </div>
            <div className="w-[0.5px] h-12 bg-[#DBD0C2]" />
            <div className="text-center">
              <p className="font-heading text-[28px] text-[#2F3430] font-light leading-none">{s.agg_coa}</p>
              <p className="font-sans text-[10px] text-[#3D4E3D] mt-1 font-light">COA Provided</p>
            </div>
          </div>
        </div>
      </div>
