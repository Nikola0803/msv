...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[580px] md:min-h-[680px] lg:min-h-[760px] flex items-center overflow-hidden">
      ...
      {/* Dark gradient overlay - deeper at bottom, lighter at top */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-0">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left lg:pr-8">
            {/* Small label with animated underline */}
            <div
            ...
            {/* Main headline */}
            <h1
              className={`font-heading text-[46px] sm:text-[56px] md:text-[64px] lg:text-[72px] leading-[1.05] text-[#E1E4D9] mb-5 font-light tracking-[0.01em] transition-all duration-700 delay-150 ${
            ...
            {/* Tagline */}
            <p
              className={`font-heading italic text-[20px] md:text-[24px] text-[#DBD0C2] mb-10 font-light tracking-[0.02em] transition-all duration-700 delay-300 ${
                visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
            >
              {s.tagline}
          ...
          {/* Right - MSV logo display */}
          <div
            className={`flex-shrink-0 hidden lg:block transition-all duration-700 delay-300 ${
              visible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'
            }`}
          >
            <div className="relative border border-[#B08D57]/30 p-1">
              <div className="w-[320px] h-[420px] xl:w-[380px] xl:h-[500px] flex items-center justify-center bg-[#2F3430]/60 backdrop-blur-sm">
                <LogoImage />
              </div>
            </div>
          </div>
