  ...
  return (
    <section className="py-16 md:py-20 bg-[#E1E4D9]" id="newsletter">
      <div className="max-w-2xl mx-auto px-4 md:px-6 text-center">
        ...
        <p className="font-sans text-[13px] text-[#7A8A76] mb-8 font-light">
          {s.tagline}
        </p>
        ...
        {submitted ? (
          <div className="p-6 border border-[#B08D57] bg-white rounded-[4px]">
            ...
            <p className="font-sans text-xs text-[#7A8A76] mt-2 font-light">
              {s.success_body}
            </p>
          </div>
        ) : (
          ...
          >
            <input
              ...
              required
              className="flex-1 bg-white border border-[#DBD0C2] py-3 px-4 font-sans text-[13px] text-[#2F3430] placeholder:text-[#7A8A76] focus:outline-none focus:border-[#B08D57] rounded-[2px] transition-colors font-light"
            />
            <button
              type="submit"
              disabled={loading}
        ...
        <p className="font-sans text-[10px] text-[#7A8A76]/60 mt-4 font-light">
          {s.disclaimer}
        </p>
      </div>
    </section>
