          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                By accessing or using the My Secret Vitality website ("Site"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you must not access or use the Site. These Terms constitute a legally binding agreement between you and My Secret Vitality, LLC ("My Secret Vitality," "we," "us," or "our").
              </p>
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
            ...
            <div className="space-y-6">
              ...
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                All content on the Site, including text, graphics, logos, images, product photography, and software, is the property of My Secret Vitality or its licensors and is protected by copyright, trademark, and other intellectual property laws.
              </p>
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
            ...
            <div className="space-y-6">
              ...
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
                To the fullest extent permitted by law, My Secret Vitality shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Site or purchase of products, including but not limited to personal injury, property damage, or loss of profits.
              </p>
              <p className="font-body text-sm text-foreground-600 leading-relaxed">
