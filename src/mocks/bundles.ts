...
export const bundles: Bundle[] = [
  {
    ...
    contents: ['BPC-157/TB-500 Blend', 'GLOW Blend'],
    items: [
      { productId: '1', defaultDosage: '10mg' },
      { productId: '4', defaultDosage: '70mg' },
    ],
    originalPrice: 300,
    bundlePrice: 219,
    savingsPct: 27,
  ...
  },
  {
    ...
    contents: ['Semaglutide', 'Tirzepatide', 'Retatrutide'],
    items: [
      { productId: '6', defaultDosage: '5mg' },
      { productId: '8', defaultDosage: '10mg' },
      { productId: '11', defaultDosage: '10mg' },
    ],
    originalPrice: 460,
    bundlePrice: 368,
    savingsPct: 20,
