...
const DEFAULTS: SectionsData = {
  ...
  hero: {
    bg_image_url: '',
    image_url:    '',
    label1:       'My Secret Vitality',
    label2:       'Beauty Kept Private',
    headline:     'Private\nWellness.\nExtraordinary\nResults.',
  ...
  about: {
    paragraph1: 'My Secret Vitality was founded by a female military veteran, for the women driving peptide research forward — built on a simple frustration: the research peptide market had become a race to the bottom, where transparency was optional and purity was negotiable.',
    ...
    stats: [
      { value: 'Veteran-Led', label: 'Founded & Run' },
