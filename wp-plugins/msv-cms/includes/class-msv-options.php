...
/**
 * Manages all MSV CMS settings stored in a single wp_option key.
 * Exposed via REST at /wp-json/msv/v1/settings (GET + POST).
 */
class MSV_Options {
    ...
    public static function defaults(): array {
        return [
            ...
            'zelle_name'        => 'MSV Research LLC',
            'cashapp_tag'       => '$MSVResearch',
            'venmo_tag'         => '@MSVResearch',
            ...
            // Contact
            'contact_email'     => 'support@mysecretvitality.com',
    ...
    public static function register_settings_route() {
        register_rest_route( 'msv/v1', '/settings', [
            [
