...
/**
 * Registers the MSV CMS top-level admin menu and all sub-pages.
...
class MSV_Admin {
    ...
    public static function init() {
        ...
        add_action( 'admin_post_msv_save_settings', [ __CLASS__, 'handle_save_settings' ] );
    }
    ...
    public static function register_menus() {
        ...
        // Settings sub-page
        add_submenu_page( 'msv-cms', 'Site Settings', 'Site Settings', 'manage_options', 'vcms-settings', [ __CLASS__, 'render_settings' ] );

        // CPT sub-pages
        add_submenu_page( 'msv-cms', 'FAQs',          'FAQs',          'edit_posts',     'edit.php?post_type=vpms_faq' );
        add_submenu_page( 'msv-cms', 'Testimonials',  'Testimonials',  'edit_posts',     'edit.php?post_type=vpms_testimonial' );
        add_submenu_page( 'msv-cms', 'COA Files',     'COA Files',     'edit_posts',     'edit.php?post_type=vpms_coa' );
        add_submenu_page( 'msv-cms', 'Hero Slides',   'Hero Slides',   'edit_posts',     'edit.php?post_type=vpms_hero' );
    }
    ...
    public static function render_settings() {
        ...
        <div class="wrap">
            ...
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                <?php wp_nonce_field( 'msv_save_settings' ); ?>
                <input type="hidden" name="action" value="msv_save_settings">
    ...
    public static function handle_save_settings() {
        if ( ! current_user_can( 'manage_options' ) || ! check_admin_referer( 'msv_save_settings' ) ) {
    ...
    public static function enqueue_assets( $hook ) {
        if ( strpos( $hook, 'msv' ) === false && strpos( $hook, 'vcms' ) === false ) return;
