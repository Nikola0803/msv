...
/**
 * Custom REST endpoints for the My Secret Vitality React frontend.
 *
 * Base: /wp-json/msv/v1/
 *
 * Endpoints:
 ...
 *   GET  /settings        — site settings (handled by MSV_Options)
...
class MSV_REST_API {
    ...
    public static function mark_order_paid( WP_REST_Request $req ): WP_REST_Response {
        ...
        $order->update_status( 'processing', $note ?: 'Payment confirmed manually via MSV CMS.' );
